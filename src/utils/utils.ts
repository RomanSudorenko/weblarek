...
export function setCategory(element: HTMLElement,category: string): void {
    element.textContent = category;

    for (const [name, className] of Object.entries(categoryMap)) {
        element.classList.toggle(className, name === category);
    }
}